...
// One-time price to unlock paths. Single source of truth — used in copy and the meta row.
...
export function buildShareMessage(link: string): string {
  return `Hey — I'm using Mande to figure out my career path, and I'd love your help unlocking it. It's a one-time ${PRICE}. Here's my link: ${link}`
}
