...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-1 border bg-border">
        <svg width="6" height="14" viewBox="0 0 6 14" fill="currentColor" className="opacity-50" aria-hidden>
