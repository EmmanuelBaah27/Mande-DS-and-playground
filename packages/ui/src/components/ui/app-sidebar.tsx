  ...
  return (
    <div className="flex flex-col gap-0.5">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((v) => !v)}
        className="inline-flex self-start items-center gap-0.5 px-2 py-0.5 select-none text-left rounded-1 hover:bg-subtle [transition:background-color_150ms_ease]"
      >
