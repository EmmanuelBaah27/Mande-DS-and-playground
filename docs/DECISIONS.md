...
### Storybook 8 with Webpack (not Vite)
**Why:** Friend's original setup used webpack. Storybook's React-webpack5 framework. Works with the custom PostCSS/Tailwind v4 integration.
